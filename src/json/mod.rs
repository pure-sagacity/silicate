...
pub fn get_secrets_from_files(config_dir: &str, websites: Vec<String>) -> Vec<Secret> {
...
pub fn write_secrets_to_files(config_dir: &str, secrets: Vec<Secret>) {
...
pub fn export_secrets_to_json(secrets: Vec<Secret>, path: Option<String>) {
...
pub fn import_secrets_from_json(path: String) -> Vec<Secret> {
